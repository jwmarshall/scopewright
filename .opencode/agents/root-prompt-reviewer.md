---
description: Read-only auditor for CLAUDE.md, AGENTS.md, and other repository root prompts. Use for token economy, safety, structure, and delegation verdicts.
mode: subagent
permission:
  edit: deny
  bash: deny
